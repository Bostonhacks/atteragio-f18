...
>>>>>>> 0911767599268217d6d32c0f7452282d2917bd3f
    <div class="schedule-block">
      <div class="select-date">
        ...
        <div v-on:click="changeDate" class="date-tag" v-bind:class="[sat_day ? 'inactive-tag' : 'active-tag']">
          <span> Sunday </span>
        </div>
      </div>
